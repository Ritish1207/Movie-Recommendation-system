...
# import Dataset 
anime = pd.read_csv(r"C:\Users\VARMA\Desktop\assignments\inclass\recomendationSystems\Recommender_System (1)\anime.csv", encoding = 'utf8')

# Database Connection
from sqlalchemy import create_engine

engine = create_engine("mysql+pymysql://{user}:{pw}@localhost/{db}".format(user = "root", pw = "ritish", db = "ritish"))
...
rec
ex=get_recommendations("Toy Story (1995)", topN=5)
ex
